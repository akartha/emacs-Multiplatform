...
(define-key avy-custom-keymap "L" 'avy-move-line) 
(define-key avy-custom-keymap "m" 'avy-move-region) 
(define-key avy-custom-keymap "p" 'avy-goto-line-above) 
(define-key avy-custom-keymap "n" 'avy-goto-line-below) 
(define-key avy-custom-keymap "c" 'avy-goto-char-timer) 
(define-key avy-custom-keymap "w" 'avy-goto-word-0) 
(define-key avy-custom-keymap "t" 'avy-transpose-lines-in-region) 
(define-key avy-custom-keymap "k" 'avy-kill-ring-save-whole-line) 
(define-key avy-custom-keymap "K" 'avy-kill-whole-line) 
(define-key avy-custom-keymap "r" 'avy-kill-ring-save-region) 
(define-key avy-custom-keymap "R" 'avy-kill-region) 
(define-key avy-custom-keymap "s" 'avy-goto-symbol-1) 
(define-key avy-custom-keymap "h" 'avy-org-goto-heading-timer) 
;;(define-key avy-custom-keymap "" ') 
...
(use-package crux
  ...
  (:map ak-crux-map
   ...
   ;;     ("U" . crux-view-url)                        
        ...
        ("0" . crux-other-window-or-switch-buffer)   
